...
import com.imalljoy.insights.entity.QuestionVo;
        ...
        if (mStatus != 0) {
            ...
            if (mVo != null && mVo.getQuestions() != null && mVo.getQuestions().size()>0) {
                for (QuestionVo questionVo : mVo.getQuestions()) {
                    View titleLayout = LayoutInflater.from(this).inflate(R.layout.layout_question_title,mContainer, false);
                    ...
                    for (String str : questionVo.getOptions()) {
                        View optionLayout = LayoutInflater.from(this).inflate(R.layout.layout_question_option, mContainer, false);
                        TextView option = (TextView) optionLayout.findViewById(R.id.option);
                        option.setText(str);
