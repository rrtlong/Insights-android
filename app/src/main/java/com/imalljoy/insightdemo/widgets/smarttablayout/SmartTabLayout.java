 ...
 */
package com.imalljoy.insightdemo.widgets.smarttablayout;
...
public class SmartTabLayout extends HorizontalScrollView {
    ...
    public void setType(boolean isExplore) {
        this.isExplore = isExplore;
    }

    public void setOnCurrentClick(CurrentClick currentClick) {
